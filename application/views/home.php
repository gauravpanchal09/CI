            ...
            <div class="carousel-item active">
               <div class="banner_section">
                  <div class="container">
                     <div class="row">
                        <div class="col-md-6">
                           <h1 class="banner_taital">Gynaecology <br><span style="color: #151515;">Care</span></h1>
                           <p class="banner_text">MBBS, MS - Obstetrics & Gynaecology, Fellow of Indian College of Obstetrics and Gynecology (FICOG) Infertility Specialist, Laparoscopic Surgeon (Obs & Gyn), Gynecologist, Obstetrician
35 Years Experience Overall and specialist</p>
                           <div class="btn_main">
                        ...
                        <div class="col-md-6">
                           <div class="image_1"><img src="<?php echo base_url(); ?>assets/images/img-1.png"></div>
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <div class="health_section layout_padding">
      <div class="container">
         ...
         <div class="health_section layout_padding">
            <div class="row">
               <div class="col-sm-7">
                  <div class="image_main">
                     <div class="main">
                        <img src="<?php echo base_url(); ?>assets/images/img-2.png" alt="Avatar" class="image" style="width:100%">
                     </div>
                     <div class="middle">
                        <div class="text"><img src="<?php echo base_url(); ?>assets/images/icon-1.png" style="width: 40px;"></div>
                     </div>
                  </div>
               </div>
               <div class="col-sm-5">
                  <div class="image_main_1">
                     <div class="main">
                        <img src="<?php echo base_url(); ?>assets/images/img-3.png" alt="Avatar" class="image" style="width:100%">
                     </div>
                     <div class="middle">
                        <div class="text"><img src="<?php echo base_url(); ?>assets/images/icon-1.png" style="width: 40px;"></div>
                     </div>
            ...
            <div class="getquote_bt_1"><a href="#">Read More <span><img src="<?php echo base_url(); ?>assets/images/right-arrow.png"></span></a></div>
         </div>
      </div>
   </div>
   <!-- health section end -->
      ...
      <div class="container">
         <div class="knowledge_main">
            ...
            <div class="right_main">
               <div class="play_icon"><a href="#"><img src="<?php echo base_url(); ?>assets/images/play-icon.png"></a></div>
            </div>
         </div>
      </div>
   </div>
         ...
         <div class="news_section_2 layout_padding">
            <div class="row">
               <div class="col-lg-4 col-sm-6">
                  <div class="box_main">
                     <div class="icon_1"><img src="<?php echo base_url(); ?>assets/images/icon-2.png"></div>
                     <h4 class="daily_text">Daily care experts</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-sm-6">
                  <div class="box_main active">
                     <div class="icon_1"><img src="<?php echo base_url(); ?>assets/images/icon-3.png"></div>
                     <h4 class="daily_text_1">Available 24/7</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-sm-6">
                  <div class="box_main">
                     <div class="icon_1"><img src="<?php echo base_url(); ?>assets/images/icon-4.png"></div>
                     <h4 class="daily_text_1">Balanced care</h4>
                  </div>
               </div>
            </div>
         </div>
         <div class="getquote_bt"><a href="#">Get A Quote <span><img src="<?php echo base_url(); ?>assets/images/right-arrow.png"></span></a></div>
      </div>
   </div>
   <!-- news section end -->
      ...
      <div class="container">
         ...
         <div class="news_section_2">
            <div class="row">
               <div class="col-md-6">
                  <div class="icon_main">
                     <div class="icon_7"><img src="<?php echo base_url(); ?>assets/images/icon-7.png"></div>
                     <h4 class="diabetes_text">Diabetes and obesity Counselling </h4>
                  </div>
                  <div class="icon_main">
                     <div class="icon_7"><img src="<?php echo base_url(); ?>assets/images/icon-5.png"></div>
                     <h4 class="diabetes_text">Obstetrics and Gynsecology</h4>
                  </div>
                  <div class="icon_main">
                     <div class="icon_7"><img src="<?php echo base_url(); ?>assets/images/icon-6.png"></div>
               ...
               <div class="container">
                  ...
                  <div class="client_section_2">
                     <div class="client_left">
                        <div><img src="<?php echo base_url(); ?>assets/images/client-img.png" class="client_img"></div>
                     </div>
                     <div class="client_right">
                        ...
                        <div class="quote_icon"><img src="<?php echo base_url(); ?>assets/images/quote-icon.png"></div>
                     </div>
                  </div>
               </div>
            </div>
